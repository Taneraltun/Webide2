sap.ui.define([
	...
	return Opa5.extend("com.toros.ZPM_MALF_NOTIF.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/toros/ZPM_MALF_NOTIF/localService/mockserver"], function (mockserver) {
